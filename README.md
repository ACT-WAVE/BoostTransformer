# BoostTransformer
PyTorch implementation for "BoostTransformer: A Lightweight Transformer for Remote Sensing Image Captioning".
...
```
## Data preparation
Download Sydney-Captions, UCM-Captions and RSICD dataset from:  
