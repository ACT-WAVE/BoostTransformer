...
class Sydney(PairedDataset):
    def __init__(self, image_field, index_split,
                 text_field, img_root, ann_root, id_root=None, 
                 use_restval=True, cut_validation=False):
        roots = {}
        ...
        super(Sydney, self).__init__(examples, {'image': image_field, 'text': text_field})
    ...
    @classmethod
    def get_samples(cls, img_root, ann_root, index_split, ids_dataset=None):
        train_samples = []
        val_samples = []
        test_samples = []
    ...
    def __init__(self, image_field, index_split,
        ...
        with nostdout():
            self.train_examples, self.val_examples, self.test_examples = self.get_samples(img_root, ann_root,
                                                                                          index_split, ids)
        examples = self.train_examples + self.val_examples + self.test_examples
        super(UCM, self).__init__(examples, {'image': image_field, 'text': text_field})
    ...
    def __init__(self, image_field, index_split,
        ...
        with nostdout():
            self.train_examples, self.val_examples, self.test_examples = self.get_samples(img_root, ann_root,
                                                                                          index_split, ids)
        examples = self.train_examples + self.val_examples + self.test_examples
        super(RSICD, self).__init__(examples, {'image': image_field, 'text': text_field})
